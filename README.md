...
- **Chat file drop** - Drag project files into chat as `@relative/path` references, or attach files from outside the project.
...
- Enable file drop into chat, using `@relative/path` for project files.

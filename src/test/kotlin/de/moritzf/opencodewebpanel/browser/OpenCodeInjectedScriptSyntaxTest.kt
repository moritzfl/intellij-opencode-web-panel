...
class OpenCodeInjectedScriptSyntaxTest {
    ...
    private fun generatedScripts(): List<Pair<String, String>> {
        ...
        return listOf(
            ...
            "pasteCapture" to OpenCodeBrowserSnippets.buildCaptureClipboardPasteScript(hostile, enabled = true),
            "paste" to OpenCodeBrowserSnippets.buildClipboardPasteScript(listOf(dropped), hostile, listOf("file:$hostile"), hostile, callback, enabled = true),
